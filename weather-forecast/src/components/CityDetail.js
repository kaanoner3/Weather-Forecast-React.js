...
class CityDetail extends Component {
  ...
  render() {
    return (
      ...
      >
        <h1 className="text-4xl text-indigo-darker">5-day forecast for {this.props.location.state.cityName}</h1>
  ...
  renderDates() {
    return this.props.cityWeatherDetail.slice(0,5).map((item,index)=> {
        return (
          <button key={item[0].dt_txt} className="w-1/5 p-2" onClick={()=>{this.handleClick(index)}}>
            <div className={`rounded shadow-md p-4 h-full flex flex-col ${this.state.dateIndex === index ? "bg-green-light" : "bg-indigo-lightest"}`}>
              <h2 className="text-lg font-bold text-indigo-darker">{format(new Date(item[0].dt * 1000), 'dddd')}</h2>
  ...
  renderForecast() {
    return this.props.cityWeatherDetail[this.state.dateIndex].map((item,index) => {
      const dateForDayName = new Date(this.props.cityWeatherDetail[this.state.dateIndex][0].dt * 1000);
      ...
      return (
        <tr key={item.dt_txt}>
          ...
          <td>
            <svg style={{ transform: `rotate(${item.wind.deg}deg)` }} className="w-12" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
              <g fill="none" fillRule="evenodd">
                <path d="M256 0C115.3 0 0 115.3 0 256s115.3 256 256 256 256-115.3 256-256S396.7 0 256 0z" fill="#68544F"/>
                <path d="M512 256c0 140.7-115.3 256-256 256V0c140.7 0 256 115.3 256 256z" fill="#53433F"/>
                <path d="M256 61C148.598 61 61 148.598 61 256c0 107.398 87.598 195 195 195s195-87.602 195-195c0-107.402-87.598-195-195-195z" fill="#EDE9E8"/>
                <path d="M451 256c0 107.398-87.598 195-195 195V61c107.402 0 195 87.598 195 195z" fill="#DFD7D5"/>
                <path d="M271 436v61c0 8.398-6.598 15-15 15-8.402 0-15-6.602-15-15v-61c0-8.402 6.598-15 15-15 8.402 0 15 6.598 15 15zM271 15v61c0 8.398-6.598 15-15 15-8.402 0-15-6.602-15-15V15c0-8.402 6.598-15 15-15 8.402 0 15 6.598 15 15z" fill="#68544F"/>
                <path d="M497 271h-61c-8.29 0-15-6.71-15-15s6.71-15 15-15h61c8.29 0 15 6.71 15 15s-6.71 15-15 15z" fill="#53433F"/>
                <path d="M76 271H15c-8.29 0-15-6.71-15-15s6.71-15 15-15h61c8.29 0 15 6.71 15 15s-6.71 15-15 15z" fill="#68544F"/>
                <path d="M271 15v61c0 8.398-6.598 15-15 15V0c8.402 0 15 6.598 15 15zM271 436v61c0 8.398-6.598 15-15 15v-91c8.402 0 15 6.598 15 15z" fill="#53433F"/>
                <path d="M358.898 339.398L269.801 131.5c-2.403-5.402-8.102-8.102-13.801-8.102-5.7 0-11.398 2.7-13.8 8.102l-89.098 207.898c-2.704 5.7-1.2 12.301 3.296 16.801 4.504 4.2 11.403 5.399 17.102 2.403L256 317.8l82.5 40.8c5.7 2.997 12.598 1.797 17.102-2.402 4.496-4.5 6-11.101 3.296-16.8z" fill="#70DA40"/>
                <path d="M355.602 356.2c-4.504 4.198-11.403 5.398-17.102 2.402L256 317.8V123.398c5.7 0 11.398 2.704 13.8 8.102l89.098 207.898c2.704 5.7 1.2 12.301-3.296 16.801z" fill="#49A520"/>
              </g>
            </svg>
