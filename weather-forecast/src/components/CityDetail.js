...
class CityDetail extends Component {
  ...
  render() {
    ...
    return (
      <main
        class="container mx-auto mt-2 p-4"
        style={{ backgroundColor: "#E8EFF3" }}
      >
        <div>
          <table style={{ width: "100%", backgroundColor: "#E8EFF3" }}>
            <thead className="flex">
              <tr className="flex-1">
                <th style={{width:'15%'}} className="hourly-table">Saat</th>
                <th style={{width:'7%'}} className="hourly-table">Beklenen Hadise</th>
                <th className="hourly-table">Sıcaklık</th>
                <th className="hourly-table">Hissedilen Sıcaklık (°C)</th>
                <th className="hourly-table">Nem (%) </th>
                <th className="hourly-table">Ort. Rüzgar Hızı (km/sa)</th>
                <th className="hourly-table">Maks. Rüzgar Hızı (km/sa)</th>
              </tr>
            </thead>
          </table>
        </div>
        <h1 class="text-4xl text-indigo-darker">5-day forecast for Buca</h1>

        <div class="flex flex-col mt-4 -my-4">
          <div class="w-1/5">
            <div class="rounded shadow-md bg-indigo-lightest my-4 p-4 h-full flex flex-col">
              <h2 class="text-lg font-bold text-indigo-darker">Saturday</h2>

              <div class="mt-4 flex-1 inline-flex flex-row items-center">
                <svg
                  class="fill-current w-12 text-yellow-dark"
                  viewBox="0 0 46 46"
                ...
                <p class="text-4xl ml-3">17°</p>
              </div>

              <div class="mt-4 flex flex-row text-grey-dark text-sm">
                ...
                <div class="ml-4 flex flex-row items-center">
                  <svg
                    class="fill-current h-4 mr-2 -mt-px"
                    viewBox="0 0 307 503"
                    xmlns="http://www.w3.org/2000/svg"
                  >
                    <path
